...
public class ButtonFloat extends Button{
	...
	protected void setDefaultProperties(){
		rippleSpeed = Utils.dpToPx(rippleSpeedDP, getResources());
...
//		super.setDefaultProperties();
	...
	protected void setAttributes(AttributeSet attrs){
		...
		if(rSpeed!=-1){
			rippleSpeedDP=rSpeed;
			//setRippleSpeed(Utils.dpToPx(rSpeed,this.getResources()));
		}else{
			//setRippleSpeed(Utils.dpToPx(2,this.getResources()));
		}
